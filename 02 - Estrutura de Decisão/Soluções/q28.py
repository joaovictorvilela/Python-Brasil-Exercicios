...
print('2 - Alcatra')
print('3 - Picanha')
tipoCarne = str(input('Informe o tipo da carne escolhida: ')).upper()

# Escolha da quantidade
quantidade = int(input('Informe a quantidade comprada: '))

# Verifica cartao
cartaoTabajara = str(input('Usara cartao Tabajara (S/N): ')).upper()
...
print(f'Valor a Pagar: {(valorBruto - desconto)}')